...
/* --- High-Level "Python-like" API Implementation --- */

char* readline(const char* prompt) {
    /* Auto-allocate buffer for the noob, managed by ARC */
...
void* py_alloc(uint64 size) { return alloc(size); }
void  py_free(void* ptr) { release(ptr); }
